		...
		<div class="row">
			<div class="col-sm-6">
				<div class="servico1">
					...
					<a type="button" href="https://www.dropbox.com/s/veq1kmzdfd85jc1/Portf%C3%B3lio%20Completo%20Uniplus%202018.pdf?dl=0" class="btn btn-primary btn-lg" style="border-radius: 15px;">Ver Apresentação</a>
				</div>	
			</div>
			<div class="col-sm-6">
...
<div class="servico3">
	<div class="container">
	  	...
	  	<div class="row">
	    	<div class="col-sm-4">
				...
				<div>
					<h5 class="text-center"><strong>Bares e Restaurantes</strong></h5>
				     <p class="text-center">Um atendimento mais ágil e eficiente para empresas do segmento gastronômico.</p>
				    </div>
	    	</div>
	    	<div class="col-sm-4">
	      		<div class="text-center">
	    	...
	    	<div class="col-sm-4">
	      		<div class="text-center">
	      			<a class="btn btn-link" href="tef.php"><i class="fas fa-sitemap fa-3x hvr-float" aria-hidden="true"></i></a>			    		
			    </div>
				<div>
	  	...
	  	<div>
	  		<div class="solucoes">
	  			<h2 class="text-center text-uppercase"><strong>Soluções desenvolvidas de acordo com a necessidade de cada segmento.</strong></h2>
	  		</div>
	  		<br>
	  		<hr class="faixa" align="center">
	  		<br><br>
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<p><strong>Nildomar – O Escadão Material de Construção</strong></p>
		</div>
	</div>	
