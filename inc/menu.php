<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #FFFFFF">
  <div class="container">
    <a class="navbar-brand" href="index.php"><img src="img/Logo-Uniplus1.png" width="190" height="55" alt=""></a>
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Integrações</a>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="tef.php">Unitef Scope</a>
              <a class="dropdown-item" href="mixfiscal.php">Mix Fiscal</a>
            </div>
        </li>
        <li class="nav-item">
