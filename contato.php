      ...
      <div class="col-sm-6">
        <form>
          ...
          <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" >
            ...
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="(xx) 00000-0000">
            <label for="formGroupExampleInput">Cidade</label>
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Recife">
            <label for="formGroupExampleInput">Estado</label>
            <input type="text" class="form-control" id="formGroupExampleInput" placeholder="PE">
          </div>
          <div class="form-group">
