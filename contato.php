      ...
      <div class="col-sm-6">
        <form action="processa_envio.php" method="post">
          <div class="form-group">
            ...
            <input name="nome" type="text" class="form-control" id="formGroupExampleInput" required="Preencha o campo">
            <label for="exampleFormControlInput1">Email</label>
            <input name="email" type="email" class="form-control" id="exampleFormControlInput1" required="Preencha o campo" >
            <label for="formGroupExampleInput">Telefone</label>
            <input name="telefone" type="text" class="form-control" id="formGroupExampleInput" required="Preencha o campo">
            <label for="formGroupExampleInput">Cidade</label>
            <input name="cidade" type="text" class="form-control" id="formGroupExampleInput" required="Preencha o campo">
            <label for="formGroupExampleInput">Estado</label>
            <input name="estado" type="text" class="form-control" id="formGroupExampleInput" required="Preencha o campo">
          </div>
          <div class="form-group">
